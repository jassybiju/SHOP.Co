		...
		<div className="w-3/5 mx-auto shadow-xl ring  ring-gray-200 rounded-xl px-20 py-10 ">
			...
			<div className="flex gap-10 w-full flex-col">
                ...
                <div className="mb-1 flex items-center gap-2 rounded-lg bg-muted p-2">
                  <code className="flex-1 font-mono text-sm font-bold text-foreground">{x.code}</code>
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  {x.min_order_amount && (
                    <p>
                      <span className="font-semibold text-foreground">Minimum Order Amount:</span> {x.min_order_amount} <br />
                      <span className="font-semibold text-foreground">Max Discount Amount:</span> {x.max_discount_amount}
                    </p>
                  )}
                  <p>
                    <span className="font-semibold text-foreground">Expires:</span> {x.expiry_date}
                  </p>
                </div>
              </div>
                ))}
