		...
		<>
			<div>
				...
				<div className="text-center py-10">
					<div className="w-50 h-50 bg-red-600 rounded-full flex items-center justify-center text-8xl mx-auto text-white">
						X
					</div>
                ...
                <div className="flex justify-between"><span>Total Amount</span><span>asdf</span></div>
					...
					<Link
						to={"/account/orders"}
						className="mx-auto w-1/4 bg-black rounded-full text-white text-xl py-2 px-10 my-5"
					>
						track order
					</Link>
					<button
